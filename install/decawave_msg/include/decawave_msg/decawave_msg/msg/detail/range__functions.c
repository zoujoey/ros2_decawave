...
decawave_msg__msg__Range__init(decawave_msg__msg__Range * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    decawave_msg__msg__Range__fini(msg);
    return false;
  }
  // from_id
...
decawave_msg__msg__Range__create()
{
  ...
  decawave_msg__msg__Range * msg = (decawave_msg__msg__Range *)allocator.allocate(sizeof(decawave_msg__msg__Range), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(decawave_msg__msg__Range));
  bool success = decawave_msg__msg__Range__init(msg);
  if (!success) {
...
decawave_msg__msg__Range__Sequence__init(decawave_msg__msg__Range__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  decawave_msg__msg__Range * data = NULL;

  if (size) {
    data = (decawave_msg__msg__Range *)allocator.zero_allocate(size, sizeof(decawave_msg__msg__Range), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = decawave_msg__msg__Range__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        decawave_msg__msg__Range__fini(&data[i - 1]);
      }
...
decawave_msg__msg__Range__Sequence__fini(decawave_msg__msg__Range__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      decawave_msg__msg__Range__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  decawave_msg__msg__Range__Sequence * array = (decawave_msg__msg__Range__Sequence *)allocator.allocate(sizeof(decawave_msg__msg__Range__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = decawave_msg__msg__Range__Sequence__init(array, size);
  if (!success) {
...
decawave_msg__msg__Range__Sequence__destroy(decawave_msg__msg__Range__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    decawave_msg__msg__Range__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
decawave_msg__msg__Range__Sequence__are_equal(const decawave_msg__msg__Range__Sequence * lhs, const decawave_msg__msg__Range__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!decawave_msg__msg__Range__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  decawave_msg__msg__Range__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(decawave_msg__msg__Range);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    decawave_msg__msg__Range * data =
      (decawave_msg__msg__Range *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!decawave_msg__msg__Range__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          decawave_msg__msg__Range__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!decawave_msg__msg__Range__copy(
