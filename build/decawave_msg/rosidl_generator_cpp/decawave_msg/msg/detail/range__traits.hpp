...
#ifndef DECAWAVE_MSG__MSG__DETAIL__RANGE__TRAITS_HPP_
#define DECAWAVE_MSG__MSG__DETAIL__RANGE__TRAITS_HPP_
...
inline void to_yaml(
  const decawave_msg::msg::Range & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const decawave_msg::msg::Range & msg)
{
  return decawave_msg::msg::to_yaml(msg);
}

template<>
inline const char * data_type<decawave_msg::msg::Range>()
{
  return "decawave_msg::msg::Range";
}

template<>
inline const char * name<decawave_msg::msg::Range>()
{
  return "decawave_msg/msg/Range";
}

template<>
struct has_fixed_size<decawave_msg::msg::Range>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<decawave_msg::msg::Range>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<decawave_msg::msg::Range>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // DECAWAVE_MSG__MSG__DETAIL__RANGE__TRAITS_HPP_
