...
#include "decawave_msg/msg/detail/deca_range__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const decawave_msg::msg::DecaRange & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  decawave_msg::msg::DecaRange & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const decawave_msg::msg::DecaRange *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<decawave_msg::msg::DecaRange *>(
    untyped_ros_message);
...
static size_t _DecaRange__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_DecaRange(full_bounded, is_plain, 0);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_decawave_msg
const rosidl_message_type_support_t *
get_message_type_support_handle<decawave_msg::msg::DecaRange>()
{
  return &decawave_msg::msg::typesupport_fastrtps_cpp::_DecaRange__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, decawave_msg, msg, DecaRange)() {
  return &decawave_msg::msg::typesupport_fastrtps_cpp::_DecaRange__handle;
}
