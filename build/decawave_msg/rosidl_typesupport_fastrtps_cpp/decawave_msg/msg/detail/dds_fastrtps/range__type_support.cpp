...
#include "decawave_msg/msg/detail/range__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const decawave_msg::msg::Range *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<decawave_msg::msg::Range *>(
    untyped_ros_message);
...
{
  return &decawave_msg::msg::typesupport_fastrtps_cpp::_Range__handle;
}
