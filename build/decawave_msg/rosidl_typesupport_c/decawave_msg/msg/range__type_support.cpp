...
static const _Range_type_support_symbol_names_t _Range_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, decawave_msg, msg, Range)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, decawave_msg, msg, Range)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, decawave_msg, msg, Range)() {
  return &::decawave_msg::msg::rosidl_typesupport_c::Range_message_type_support_handle;
}
