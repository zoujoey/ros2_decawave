...
static const _DecaRange_type_support_symbol_names_t _DecaRange_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, decawave_msg, msg, DecaRange)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, decawave_msg, msg, DecaRange)),
  }
};
...
{
  return &::decawave_msg::msg::rosidl_typesupport_cpp::DecaRange_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, decawave_msg, msg, DecaRange)() {
  return get_message_type_support_handle<decawave_msg::msg::DecaRange>();
}
