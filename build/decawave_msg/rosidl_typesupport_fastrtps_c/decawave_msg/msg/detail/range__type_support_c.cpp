...
#include "decawave_msg/msg/detail/range__rosidl_typesupport_fastrtps_c.h"
...
#include "decawave_msg/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_decawave_msg
...
using _Range__ros_msg_type = decawave_msg__msg__Range;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_decawave_msg
size_t get_serialized_size_decawave_msg__msg__Range(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Range__ros_msg_type * ros_message = static_cast<const _Range__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Range__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_decawave_msg__msg__Range(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_decawave_msg
size_t max_serialized_size_decawave_msg__msg__Range(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Range__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_decawave_msg__msg__Range(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, decawave_msg, msg, Range)() {
