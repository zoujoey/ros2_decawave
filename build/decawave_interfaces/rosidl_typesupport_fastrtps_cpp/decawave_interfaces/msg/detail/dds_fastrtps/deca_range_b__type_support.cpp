...
#include "decawave_interfaces/msg/detail/deca_range_b__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const decawave_interfaces::msg::DecaRangeB & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  decawave_interfaces::msg::DecaRangeB & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const decawave_interfaces::msg::DecaRangeB *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<decawave_interfaces::msg::DecaRangeB *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _DecaRangeB__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const decawave_interfaces::msg::DecaRangeB *>(
...
static rosidl_message_type_support_t _DecaRangeB__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_DecaRangeB__callbacks,
...
{
  return &decawave_interfaces::msg::typesupport_fastrtps_cpp::_DecaRangeB__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, decawave_interfaces, msg, DecaRangeB)() {
  return &decawave_interfaces::msg::typesupport_fastrtps_cpp::_DecaRangeB__handle;
}
