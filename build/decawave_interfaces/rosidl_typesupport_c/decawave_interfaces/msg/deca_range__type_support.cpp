...
static const _DecaRange_type_support_symbol_names_t _DecaRange_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, decawave_interfaces, msg, DecaRange)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, decawave_interfaces, msg, DecaRange)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, decawave_interfaces, msg, DecaRange)() {
  return &::decawave_interfaces::msg::rosidl_typesupport_c::DecaRange_message_type_support_handle;
}
